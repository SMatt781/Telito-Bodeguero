...
<head>
    ...
    <title>Registrar Salida · Almacén</title>
...
<header class="topbar d-md-none">
    ...
    <span class="ms-2 fw-bold">Registrar salida</span>
</header>

<!-- Contenido -->
<main id="main" class="content">
    <div class="page-wrap">
        <h1 class="text-primary fw-bold titulo-principal mb-3">Registro de salida</h1>
        <% if (error != null) { %>
            ...
            <form action="<%=ctx%>/AlmacenServlet" method="post" novalidate>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="date" id="fechaSalida" name="fechaRegistro" value="<%=hoy%>" class="form-control" required />
                    </div>

                    <div class="col-12 col-md-6">
                        <label for="cantidadProducto" class="form-label">Cantidad</label>
                        <input type="number" id="cantidadProducto" name="cantidad" class="form-control"
...
<script>
    ...
    (function setToday(){
        const el = document.getElementById('fechaSalida');
        if(!el) return;
        const d = new Date();
