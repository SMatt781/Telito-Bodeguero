...
<%
    ...
    // Conversión segura del atributo idProducto (puede venir como String o Integer)
    Integer idProducto = null;
    Object idObj = request.getAttribute("idProducto");
    if (idObj != null) {
        try {
            idProducto = Integer.parseInt(idObj.toString());
...
<head>
    ...
    <style>
        ...
        .sidebar{ position:fixed; inset:0 auto 0 0; width:280px; background:#212529; color:#fff; z-index:1000; transition:width .25s ease; overflow-y:auto; }
                ...
                <%
                    if (prods != null) {
                        for (Producto p : prods) {
                            Integer prodId = p.getIdProducto();
                %>
                <option value="<%=prodId%>" <%= (idProducto != null && idProducto.equals(prodId) ? "selected" : "") %>>
