...
<%
    ...
    Object permsObj = request.getAttribute("permisosRol");
    if (permsObj == null) permsObj = session.getAttribute("permisosRol");

    java.util.Set<Integer> permisos = java.util.Collections.emptySet();

    if (permsObj instanceof java.util.Set) {
        permisos = (java.util.Set<Integer>) permsObj;

    } else if (permsObj instanceof java.util.List) {
        java.util.HashSet<Integer> tmp = new java.util.HashSet<Integer>();
        java.util.List<?> lista = (java.util.List<?>) permsObj;
        for (Object o : lista) {
            if (o instanceof com.example.telitobodeguero.beans.Roles_has_Permisos) {
                com.example.telitobodeguero.beans.Roles_has_Permisos rp =
                        (com.example.telitobodeguero.beans.Roles_has_Permisos) o;
                if (rp.isActivacion()) {
                    tmp.add(rp.getPermisos_idPermisos());
                }
            }
        }
        permisos = tmp;
    ...
    <li class="nav-item mt-auto m-4">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                <li>
                    <form method="post" action="<%= request.getContextPath() %>/LoginServlet" style="margin:0">
