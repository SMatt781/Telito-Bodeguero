...
<%
    ...
    ArrayList<OrdenCompra> listaOrdenCompra =
            (ArrayList<OrdenCompra>) request.getAttribute("listaOrdenCompra");

    ArrayList<Producto> listaTop5StockBajo =
            (ArrayList<Producto>) request.getAttribute("listaTop5StockBajo");

    Integer totalStockBajoObj =
            (Integer) request.getAttribute("totalStockBajo");
...
<main class="main" id="main">
    ...
    <div class="container my-4" id="stock-bajo">
        <div class="d-flex align-items-center justify-content-between mb-2">
            <div class="alert alert-danger m-0 py-2 px-3 rounded-pill d-inline-flex align-items-center gap-2 fw-bold">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    <path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0zM12 9v5m0 3h.01"/>
                </svg>
        ...
        <div>
            <small class="text-muted">Mostrando 5 productos</small>
            <hr>
        </div>
